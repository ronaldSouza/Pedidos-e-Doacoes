          ...
          <h6 class="font-weight-bolder text-white mb-0">Christmas Mail</h6>
                ...
                <ul class="navbar-nav justify-content-start">
                    <li class="nav-item d-flex alig-item-center">
                        <a href="{{ route('dashboard') }}" class="nav-link text-white px-0 me-3 fs-6">
                            <i class="fa-solid fa-home me-sm-1"></i>
                            <span class="d-sm-inline d-none">Principal</span>
                        </a>
                        <a href="{{ route('pedidos.create') }}" class="nav-link text-white px-0 me-3 fs-6">
                            <i class="fa fa-envelope me-sm-1"></i>
                            <span class="d-sm-inline d-none">Fazer Pedido</span>
                        </a>
                        <a href="{{ route('pedidos.edit', Auth::user()->id) }}" class="nav-link text-white px-0 me-3 fs-6">
                          <i class="fa fa-envelope me-sm-1"></i>
                          <span class="d-sm-inline d-none">Seu Pedido</span>
                      </a>
                        <a href="{{ route('pedidos.index') }}" class="nav-link text-white px-0 fs-6">
                            <i class="fa fa-gift me-sm-1"></i>
                            <span class="d-sm-inline d-none">Doe</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav justify-content-end">
                  <div class="nav-item btn-group" role="group" aria-label="Basic mixed styles example">
                    <a href="{{ route('users.edit', Auth::user()->id) }}" class="nav-link text-white fs-6">
