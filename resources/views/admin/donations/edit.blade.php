                    ...
                    <div class="card-body pt-2">
                        ...
                        <form action="#">
                            <div class="form-group">
                                <label for="resposta">Resposta ao pedido</label>
                                <textarea class="form-control" name="resposta" id="resposta" rows="5" minlength="10" style="min-height: 100px">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam iusto, earum officia culpa iste debitis fuga, provident harum sit rem veritatis, distinctio voluptatem est. Ipsam, corrupti. Consectetur tenetur nihil nesciunt?</textarea>
                            </div>                        
